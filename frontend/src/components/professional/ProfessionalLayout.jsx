...
const ProfessionalLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/professional/analytics', label: 'Analytics', icon: BarChart3 },
    { path: '/professional/groups', label: 'Groups', icon: Users },
    { path: '/professional/modules', label: 'Modules', icon: BookOpen },
    { path: '/professional/courses', label: 'Coursework', icon: BookOpen },
    { path: '/professional/feedback-cycles', label: 'Feedback Cycles', icon: FileText },
    { path: '/professional/assessments', label: 'Assessments', icon: ClipboardList },
  ];
